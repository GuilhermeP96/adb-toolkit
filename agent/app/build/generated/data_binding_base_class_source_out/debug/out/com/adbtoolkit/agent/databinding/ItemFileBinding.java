...
public final class ItemFileBinding implements ViewBinding {
  ...
  private ItemFileBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivFileIcon,
      @NonNull TextView tvFileInfo, @NonNull TextView tvFileName, @NonNull TextView tvFileSize) {
  ...
  public static ItemFileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFileBinding((LinearLayout) rootView, ivFileIcon, tvFileInfo, tvFileName,
          tvFileSize);
    }
